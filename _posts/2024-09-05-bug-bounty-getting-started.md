...
As someone who recently got into bug hunting, I thought I’d write a short guide for getting started. Hopefully, this will help a few newcomers. My credentials, you ask? Well, what originally got me into bug bounty hunting was completing the [Bug Bounty Path](https://academy.hackthebox.com/preview/certifications/htb-certified-bug-bounty-hunter) from Hack The Box. By the way, great course! I fully recommend it for any aspiring pentesters and bug bounty hunters. 

After finishing the course, I started my bug bounty journey on HackerOne. Two weekends and a bunch of hacking away on VDP programs (I know.. I know), I had submitted 10 bugs, with 8 actually triaged. During this time, I also discovered my first zero-day vulnerability (I'll write a whole other post about that—and the joy, or lack thereof, of talking with vendors) in a COTS application. (Worth a level up? Possibly.) To be fair, this commercial application was part of a target with a `HUGE` scope meaning it probably was barely tested, and so I didn't need to dedicate as much time to research as I would with other products. But enough about me.
<p align="center">
